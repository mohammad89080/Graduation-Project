...
<div class="row">
  ...
  @if($info->updated_by>0 and $info->updated_by!=null )
        ...
        <a href="{{ route('admin.stores.edit',$info->id) }}" class="btn btn-sm p-2  btn-primary">تعديل</a>
             <a href="{{ route('admin.stores.delete',$info->id) }}" class="btn btn-sm p-2 btn-danger">حذف</a>
